...
description: Documentación del endpoint de la API para eliminar una grabación de una reunión específica del servidor.
...
Este endpoint le permite eliminar permanentemente una grabación del servidor. Esta acción es irreversible y eliminará el archivo de grabación y todos los metadatos asociados.
