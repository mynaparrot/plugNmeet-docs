...
Este objeto contiene metadatos específicos del tipo de artefacto. Por ejemplo, para un artefacto `MEETING_SUMMARY_USAGE`, podría contener información de `token_usage` y `cost`. La estructura exacta depende del tipo de artefacto.
