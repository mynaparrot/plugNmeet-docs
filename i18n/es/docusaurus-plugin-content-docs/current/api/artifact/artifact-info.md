...
| created     | string             | La marca de tiempo de creación del artefacto.                   |
| metadata    | RoomArtifactMetadata | Metadatos adicionales sobre el artefacto, que varían según el tipo. |

### RoomArtifactMetadata

Este objeto contiene metadatos específicos del tipo de artefacto. Por ejemplo, para un artefacto `MEETING_SUMMARY_USAGE`, podría contener información sobre `token_usage` y `cost`. La estructura exacta depende del tipo de artefacto.
