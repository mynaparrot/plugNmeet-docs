...
description: Documentación del endpoint de la API para verificar si una sala de videoconferencia está actualmente activa y tiene participantes.
keywords: [api, está activa, verificar sala, estado de la sala, api de sala, endpoint]
sidebar_position: 3
